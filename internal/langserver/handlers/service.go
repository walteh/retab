...
import (
	...
	"github.com/walteh/retab/internal/job"
	"github.com/walteh/retab/internal/langserver/diagnostics"
	"github.com/walteh/retab/internal/langserver/notifier"
	"github.com/walteh/retab/internal/langserver/session"
	ilsp "github.com/walteh/retab/internal/lsp"
	"github.com/walteh/retab/internal/scheduler"
	"github.com/walteh/retab/internal/settings"
	"github.com/walteh/retab/internal/source"
	"github.com/walteh/retab/internal/state"
	"github.com/walteh/retab/internal/telemetry"
...
func (svc *service) GetDocument(dh document.Handle) (*document.Document, error) {
...
func (svc *service) configureSessionDependencies(ctx context.Context, cfgOpts *settings.Options) error {
	...
	// svc.closedDirWalker = walker.NewWalker(afero.NewIOFS(svc.fs), closedPa, svc.modStore, svc.indexer.WalkedModule)
	...
	// svc.openDirWalker = walker.NewWalker(afero.NewIOFS(svc.fs), opendPa, svc.modStore, svc.indexer.WalkedModule)
	// svc.closedDirWalker.Collector = svc.walkerCollector
...
const tracerName = "github.com/walteh/retab/internal/langserver/handlers"
