...
func TestDocumentStore_UpdateDocument_basic(t *testing.T) {
	...
	err = s.DocumentStore.OpenDocument(testHandle, "retab", 0, []byte("foo"))
	if err != nil {
		t.Fatal(err)
	}
...
func TestDocumentStore_GetDocument_basic(t *testing.T) {
	...
	testHandle := document.HandleFromURI("file:///dir/test.tf")
	err = s.DocumentStore.OpenDocument(testHandle, "retab", 0, []byte("foobar"))
	if err != nil {
		t.Fatal(err)
	}
...
func TestDocumentStore_ListDocumentsInDir(t *testing.T) {
	...
	err = s.DocumentStore.OpenDocument(testHandle1, "retab", 0, []byte("foobar"))
	if err != nil {
		t.Fatal(err)
	}

	testHandle2 := document.HandleFromURI("file:///dir/test2.tf")
	err = s.DocumentStore.OpenDocument(testHandle2, "retab", 0, []byte("foobar"))
	if err != nil {
		t.Fatal(err)
	}
