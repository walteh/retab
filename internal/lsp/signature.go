...
func ToSignatureHelp(signature *lang.FunctionSignature) *lsp.SignatureHelp {
	...
	for _, p := range signature.Parameters {
		parameters = append(parameters, lsp.ParameterInformation{
			Label: p.Name,
			// TODO: Support markdown per https://github.com/walteh/retab/issues/1212
		...
		Signatures: []lsp.SignatureInformation{
			{
				...
				// TODO: Support markdown per https://github.com/walteh/retab/issues/1212
				Documentation: &lsp.Or_SignatureInformation_documentation{Value: mdplain.Clean(signature.Description.Value)},
