...
import (
	...
	"github.com/walteh/retab/gen/borrow/github.com/hashicorp/terraform-ls/internal/mdplain"
...
func ToSignatureHelp(signature *lang.FunctionSignature) *lsp.SignatureHelp {
	...
	for _, p := range signature.Parameters {
		parameters = append(parameters, lsp.ParameterInformation{
			Label: p.Name,
			// TODO: Support markdown per https://github.com/walteh/retab/gen/borrow/github.com/hashicorp/terraform-ls/issues/1212
