...
import (
	...
	"github.com/walteh/retab/gen/gopls/analysisinternal"
	"github.com/walteh/retab/gen/gopls/typesinternal"
)
...
func typesCodeHref(linkTarget string, code typesinternal.ErrorCode) string {
	return source.BuildLink(linkTarget, "github.com/walteh/retab/gen/gopls/typesinternal", code.String())
}
