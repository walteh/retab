...
func asHCLSyntax(t *Token) hclsyntax.Token {
...
func spaceAfterToken(subject, before, after *Token) bool {
	...
	case hclsyntax.Keyword([]byte{'i', 'n'}).TokenMatches(asHCLSyntax(subject)) && before.Type == hclsyntax.TokenIdent:
